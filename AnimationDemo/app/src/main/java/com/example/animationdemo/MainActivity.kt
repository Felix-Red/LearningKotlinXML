...
class MainActivity : ComponentActivity(), View.OnClickListener, Animation.AnimationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val seekBarSpeed = findViewById<SeekBar>(R.id.seekBar)
        ...
        var textSeekSpeed = findViewById<TextView>(R.id.textSeekerSpeed)

        seekBarSpeed.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener{

            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                seekSpeedProgress = progress
                textSeekSpeed.text = "$seekSpeedProgress of ${seekBarSpeed.max}"
            }
